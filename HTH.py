...
def transpileVariables(sstr123455, functionNames):
        ...
        if (variables['istAvar'] == 1):
            ...
            if (variables['isNumKindaVar'] == 1):
                ...
                if (InStr(variables['A_LoopField10'] , "%")):
                    ...
                    variables['out1'] = "variables." + variables['A_LoopField10']
                    variables['outOftranspileVariables'] += variables['out1'] + Chr(32)
        else:
            variables['outOftranspileVariables'] += variables['A_LoopField10'] + Chr(32)
    ...
    for A_Index15, A_LoopField15 in enumerate(items, start=1):
        ...
        variables['ALoopFieldFixFunc'] = variables['A_LoopField15']
        ...
        for A_Index16, A_LoopField16 in enumerate(items, start=1):
            ...
            if ("variables." + variables['ALoopFieldFixFunc'] == variables['A_LoopField16']):
    ...
    for A_Index17 in range(1, variables['numOfStrings'] + 1):
        variables['A_Index17'] = A_Index17
        variables['outOftranspileVariables'] = StrReplace(variables['outOftranspileVariables'] , "freeeeepaestine-sav-etehmtyeah-freee-n" + variables['A_Index17'] , Chr(34) + variables[f'theString{variables["A_Index17"]}'] + Chr(34))
    #OutputDebug, |%outOftranspileVariables%|
...
def transpileLowVariables(sstr):
    ...
    if (InStr(variables['sstr'] , Chr(37))):
        ...
        for A_Index18, A_LoopField18 in enumerate(items, start=1):
            ...
            if (Mod(variables['A_Index18'] , 2)):
                variables['outOftranspileVariablesOut'] += variables['A_LoopField18']
            else:
                variables['outOftranspileVariablesOut'] += Chr(34) + " + variables." + variables['A_LoopField18'] + " + " + Chr(34)
    else:
...
def compiler():
    ...
    for A_Index34, A_LoopField34 in enumerate(items, start=1):
        ...
        if (SubStr(Trim(StrLower(variables['A_LoopField34'])), 1 , 15)== StrLower("OutputDebug, % ")):
            ...
            variables['s'] = StrSplit(variables['sstr1'] , "," , 3)
            variables['out2'] = Trim(variables['s'])
            variables['out1'] = transpileLowVariables(variables['out1'])
            variables['out2'] = transpileLowVariables(variables['out2'])
            variables['out3'] = "FileAppend(" + variables['out1'] + ", " + variables['out2'] + ")"
            #MsgBox, % out3
            variables['jsCode'] += variables['out3'] + "\n"
            variables['lineDone'] = 1
